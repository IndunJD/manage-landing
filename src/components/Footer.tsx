  ...
  return (
    <div>
      <Row className="section-content-container">
        <Col lg={3} md={12} xs={12} className="logos-col">
          <div>
        ...
        <Col lg={5} md={12} xs={12} className="links-col">
          <div>
            <ul>
              <li>Home</li>
              <li>Pricing</li>
        ...
        <Col lg={4} md={12} xs={12} className="subscribe-col">
          <div className="w-100">
            <div className="d-flex">
              <input type="email" placeholder="Updates in your inbox..." />
              <Button className="btn-orange-2" style={{ marginLeft: "10px" }}>
                Go
              </Button>
            </div>
          </div>
